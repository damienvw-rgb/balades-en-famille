...
export async function sendMail({ to, subject, text, html, replyTo }) {
  ...
  await (await transport()).sendMail({ from, to, subject, text, html, replyTo });
  return { delivered: true };
}

// Réexport pour ne pas casser les routes API qui importent siteUrl d'ici.
// La définition vit dans lib/site.js, partagée avec les pages.
export { siteUrl } from "./site.js";
