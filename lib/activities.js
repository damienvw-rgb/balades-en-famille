...
//
// Le visiteur garde les trois boutons Cyclable, Relief et Plan : on choisit
// seulement celui qui s'affiche en arrivant sur la fiche, selon l'activité.
 ...
 * Sans activité, on suit getActivity() qui retombe sur le vélo.
 */
export function mapLayerFor(key) {
  if (!key) return ACTIVITY_MAP_LAYER.velo;
...
// ---------------------------------------------------------------------------
export { gearEmoji, GEAR_EMOJI_CHOICES, GEAR_FALLBACK, isKnownGearEmoji } from "./gear.js";
